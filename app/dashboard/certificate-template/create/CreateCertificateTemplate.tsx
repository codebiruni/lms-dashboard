...
export default function CreateCertificateTemplate() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Append each field individually - DON'T stringify everything into one 'data' field
            formData.append('course', selectedCourse)
            formData.append('fontFamily', fontFamily)
            formData.append('color', textColor)
            formData.append('isDelete', String(isDelete))
            
            // Append position data as JSON strings (but as separate fields)
            ...
            setStudentIdPos({ left: 200, top: 200, fontSize: 24, width: 120, height: 40 })
            setNamePos({ left: 200, top: 300, fontSize: 32, width: 200, height: 50 })
            setCourseNamePos({ left: 200, top: 400, fontSize: 28, width: 250, height: 45 })
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <div className="mt-4 text-sm text-muted-foreground space-y-1">
                                ...
                                <p>⚡ Use the Size tab in controls to fine-tune dimensions.</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
                                ...
                                <Tabs defaultValue="position" className="w-full">
                                    ...
                                    <TabsContent value="size" className="space-y-4">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Drag the blue handles on the element to resize
                                        </p>
                                    </TabsContent>
                                </Tabs>
                            )}
